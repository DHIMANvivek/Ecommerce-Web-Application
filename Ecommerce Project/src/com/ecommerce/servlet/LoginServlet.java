...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action==null)
		{
			...
			{
				com.ecommerce.pojo.User user=u.login(userEmail, userPassword);
		...
		com.ecommerce.pojo.User user=(com.ecommerce.pojo.User)session.getAttribute("active-user");
		...
		boolean flag=new com.ecommerce.dao.UserDaoImp().forgetPassword(email, phone, password);
